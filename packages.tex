...
\hypersetup{
	pdfauthor={Shayan Shahand}, 
	pdftitle={Science Gateways for Biomedical Big Data Analysis | Shayan Shahand}, 
	pdfsubject={Shayan Shahand's PhD Thesis},
	pdfkeywords={Science Gateway (SG), e-Science, Science Portal, Virtual Research Environment (VRE), Problem Solving Environment (PSE), Virtual Laboratory (VL), collaboratory, e-Research environment, e-Infrastructure, cyberinfrastructure, business reference model, Science Gateway Canvas (SGC), Science Gateway development, Science Gateway frameworks, Science Gateway technologies, Grid Portal, Big Data, Business Model Canvas, Sustainability}, 
